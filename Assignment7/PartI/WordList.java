...
public class WordList {
     ...
     * 
     * @effects Removes all the words from this word set and replaces them with the
     *          words found in the given file.
     ...
     *         contain the substring s (matched case-insensitively). A word appears
     *         at most once in the returned list.
     */
    ...
    public static void main(String[] args) {
        ...
        List<String> matches = words.find("holst");
