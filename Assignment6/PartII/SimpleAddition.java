...
public class SimpleAddition extends JFrame {
    ...
    private void setupComponentValues() {
        ...
        /*
         * Do not worry about any of this code. It just sets the GUI layout up. You
         * don't have to understand it to complete the assignment
         */
    ...
    public JPanel createContentPane() {
         ...
         * recalculate the sum any time a change occurs in either addend field. Your
         * assignment is to add action listeners that will automatically update the sum
         * Hint: the code that initializes the text of sumField can be executed again to
         * update the value to reflect the current value
         */
        InputListener changeListener = new InputListener();
        addend1Field.addActionListener(changeListener);
        addend2Field.addActionListener(changeListener);
